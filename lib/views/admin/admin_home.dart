...
import 'package:shopping/common/widget/widget.dart';
                ...
                child: Material(
                    ...
                    child: ListView.builder(
                      itemBuilder: (context, idx) {
                        return TNavigationListTile(
                          leading: _navigationListIcons[idx],
                          text: _navigationListText[idx],
                          index: idx,
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => ListTile(
        ...
        title: Text(
          text,
          style: Get.textTheme.titleSmall!.copyWith(color: TColors.grey),
        ),
        ...
        onTap: () {
          controller.activeScreenIndex.value = index;
